...
static int run_test(void)
{
	...
	peek_ok = !ptrace(PTRACE_PEEKMTETAGS, child,
	...
	iov.iov_len = TAGS_PER_PAGE;
	file_poke_ok = !ptrace(PTRACE_POKEMTETAGS,
			       child, (void *)FILE_TEST_BASE, &iov) &&
			iov.iov_len == TAGS_PER_PAGE;
