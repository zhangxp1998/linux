...
/*
 * PTRACE_PEEKMTETAGS / PTRACE_POKEMTETAGS on a stopped 4K compat tracee read
 * and write allocation tags per 4K process page, for both an anonymous
 * mapping and a file-backed 4K slice, and the tracee observes the new tags.
 */
#define _GNU_SOURCE
