...
static bool mmu_notifier_ppps_clear_young(struct mmu_notifier *notifier,
					  struct mm_struct *mm,
					  unsigned long start,
					  unsigned long end)
{
...
static struct miscdevice mmu_notifier_ppps_miscdev = {
	.minor = MISC_DYNAMIC_MINOR,
	.name = "mmu_notifier_ppps",
	.fops = &mmu_notifier_ppps_fops,
	.mode = 0600,
};

module_misc_device(mmu_notifier_ppps_miscdev);

MODULE_DESCRIPTION("PPPS MMU notifier range regression test helper");
MODULE_LICENSE("GPL");
