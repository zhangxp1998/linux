...
#if defined(CONFIG_MMU) && !defined(__ASSEMBLY__)
/*
 * Native lockless offsets may return the address of the entry argument when
 * a level is folded. Keep that argument in the caller's scope rather than
 * taking the address of an inline wrapper's by-value parameter.
 */
#ifndef p4d_offset_lockless_mm
#ifndef CONFIG_ARM64_PER_PROCESS_PAGE_SIZE
#define p4d_offset_lockless_mm(mm, pgdp, pgd, address) \
	((void)(mm), p4d_offset_lockless((pgdp), (pgd), (address)))
#else
...
#ifndef CONFIG_ARM64_PER_PROCESS_PAGE_SIZE
#define pud_offset_lockless_mm(mm, p4dp, p4d, address) \
	((void)(mm), pud_offset_lockless((p4dp), (p4d), (address)))
#else
...
#ifndef CONFIG_ARM64_PER_PROCESS_PAGE_SIZE
#define pmd_offset_lockless_mm(mm, pudp, pud, address) \
	((void)(mm), pmd_offset_lockless((pudp), (pud), (address)))
#else
