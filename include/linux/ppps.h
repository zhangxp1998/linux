...
#define mm_inherit_pagesize(mm) \
	((mm)->page_shift = current->mm ? current->mm->page_shift : PAGE_SHIFT_KERNEL)
...
#define MM_ADDR_PAGE_SHIFT(addr, mm) \
	__MM_ADDR_EVAL(addr, PAGE_SHIFT_KERNEL, MM_PAGE_SHIFT(mm))

#define MM_ADDR_PAGE_SIZE(addr, mm) \
	__MM_ADDR_EVAL(addr, PAGE_SIZE_KERNEL, MM_PAGE_SIZE(mm))

#define MM_ADDR_PAGE_MASK(addr, mm) \
	__MM_ADDR_EVAL(addr, PAGE_MASK_KERNEL, MM_PAGE_MASK(mm))
